...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // 宠物互动专属建议
  pet_interaction: [
    '和宠物互动时眼睛要看着它，自然的笑容马上就出来了～',
    '让宠物先熟悉镜头再拍，不要强迫它们～',
    '和猫狗互动时蹲下来平视，角度会更自然～',
    '用零食或玩具吸引宠物注意力，抓拍它们看向镜头的一瞬间～',
    '不要开闪光灯拍宠物，强光会吓到它们～',
    '户外阳光下拍宠物要注意曝光，逆光时要补光～',
  ],
  // 露营场景专属建议
  camping_specific: [
    '露营帐篷前光线超美！靠近帐篷站着，背景超有感觉～',
    '篝火旁超有氛围！让火光打在侧脸上，暖黄色调超浪漫～',
    '营地里找一片干净的草地或空地当背景，避免杂物入镜～',
    '露营灯光较弱，打开手机闪光灯补光，或者靠近营地灯～',
    '野餐垫上坐着拍比站着拍更稳，角度也更舒服～',
    '清晨和傍晚的光线最柔和，是露营拍照的黄金时段～',
  ],
  // 湖边场景专属建议
  lakeside_specific: [
    '湖边光线超柔！侧身站着让水面反光打在脸上～',
    '湖面平静时拍倒影超美，蹲低一点让倒影更完整～',
    '有风的时候波光粼粼更有活力，但要注意水面反光对脸的影响～',
    '湖边背景干净的话，可以拍全身照，湖水做背景超有层次～',
    '逆光拍湖面超有意境，让轮廓光勾勒出形状～',
    '湖边地面可能湿滑，注意脚下安全，站稳再拍～',
  ],
  // 画廊/博物馆场景专属建议
  gallery_specific: [
    '画廊里光线柔和均匀，是拍人像的好场所～',
    '站在艺术品旁边侧身微笑，文艺感十足～',
    '画廊空间通常较暗，打开闪光灯补光试试～',
    '背景是画作时让人和画形成互动，画面更有故事感～',
    '博物馆光线偏暗白，让女朋友稍微靠近光源或开补光灯～',
    '利用画廊的引导线或对称构图，画面会更专业～',
  ],
  // 商场橱窗场景专属建议
  mall_display_specific: [
    '商场橱窗灯光亮丽，夜晚超有都市感！让光打在侧脸上～',
    '橱窗玻璃会反光，稍微侧身躲开脸上的反光～',
    '橱窗背景颜色丰富时，穿纯色衣服会更容易突出主体～',
    '商场室内灯光偏冷白，可以让女朋友稍微侧一点避开顶光～',
    '自动扶梯上光线冷调超有都市感，靠着扶手随意自然～',
    '商场明暗对比强，用屏幕补光可以让脸更亮～',
  ],
  // 桥上夜景专属建议
  // 摩天轮场景专属建议
  ...
  // 车内/车窗自拍专属建议
  car_window_hint: [
    '车内自拍车窗是天然画框！摇下车窗让背景延伸进来～',
    '车内光线均匀，适合拍特写！侧身看向窗外，光影更立体～',
    '车窗外风景做背景时让人靠近车窗，光线和背景都能兼顾～',
    '车内有反光？让窗户关闭状态稍微挡一下光源～',
    '停在风景好的地方拍，车窗外的景色成了最美的背景～',
  ],
  // ========== Round 48 新增：旅游打卡专属建议 ==========
  travel_checkin_hint: [
    '景点打卡要有标志性背景！让主体和背景形成呼应关系～',
    '旅行打卡不要太游客照！找个有趣的角度或者错开人群～',
    '著名景点人山人海？蹲低一点让主体挡住人群，或者找侧角度～',
    '打卡照构图要有创意！不一定要正对景点，稍微侧一点更自然～',
    '景点打卡时让人站在引导线或框架里，构图立刻变专业～',
  ],
  // 雪景专属建议
  snow_specific: [
  ...
  // 闺蜜合照专属建议
  bestie_photo: [
    '闺蜜照最重要的是互动！靠近一点，笑着抓拍～',
    '闺蜜之间可以对望或牵手，互动感会让照片更生动～',
    '合照时一高一低或一前一后站，层次感会更丰富～',
    '闺蜜照可以摆同样的姿势，默契感超有趣～',
    '闺蜜照背景要干净，人多时等一下或者换个角度～',
    '让一个人近一个人远，近景特写加远景全身都入镜～',
    '闺蜜照可以看镜头也可以看对方，自然的互动最好看～',
  ],
  // 镜子自拍专属建议
  mirror_selfie: [
    '对着镜子自拍！手机稍微斜一点拍，避免镜面反光～',
    '浴室镜或穿衣镜光线最均匀，笑着看镜中的自己～',
    '镜子自拍时稍微侧身45度，比正对镜子更显瘦～',
    '前置镜头画质差，对镜拍用后置镜头画质更好～',
    '镜子要擦干净，指纹和水渍会影响效果～',
    '对着镜子拍时手机边缘不要入镜，保持画面干净～',
  ],
  // 全身照专属建议
  full_body: [
    '全身照要竖着拍，横构图会把人拍得又矮又胖～',
    '全身照时头顶要留白，不要顶到画面边缘～',
    '男友蹲低一点仰拍，显腿长是全身照的秘诀～',
    '全身照背景要完整，避免截掉脚或头顶～',
    '穿高跟鞋或踮脚可以让腿部线条更好看～',
    '全身照时让女朋友站在九宫格下方三分线位置～',
  ],
  // 侧颜专属建议
  profile_tips: [
    '侧颜照超显气质！让女朋友微微侧头，下颌线更清晰～',
    '侧颜逆光时让轮廓光超美，但正脸部分要能看清～',
    '侧颜照眼睛可以看向远方或者闭眼，都很有意境～',
    '侧颜照时脖子要伸长一点，下巴微微抬起更优雅～',
    '侧颜照要找好光线，侧光让五官更有立体感～',
    '侧颜和正脸交替拍，正侧都有更好看～',
  ],
  // 背影照专属建议
  back_view: [
    '背影照超有意境！背对镜头回头的那一瞬间抓拍～',
    '背影照时站姿要挺拔，弯腰驼背从背面看很明显～',
    '让男朋友从背后拍，牵手或靠在肩上的背影超甜～',
    '背影照背景要干净漂亮，背景决定了照片的调性～',
    '有长发的话让风吹起来，发丝飘动的背影超有氛围～',
    '背影照也可以有表情，回眸一笑让照片更生动～',
  ],
  // 抓拍专属建议
  candid_tips: [
    '抓拍时手要稳！提前对焦在人物脸上，等好时机再按～',
    '让她先做动作再抓拍，自然的笑容往往在不经意间～',
    '连拍模式开起来，多拍几张总有一张完美的～',
    '抓拍的眼神要有焦点，不要让眼神放空～',
    '假装在旁边看别的东西，然后突然转头抓拍，表情最自然～',
    '抓拍时男友要稳住，深呼吸憋住气再按快门～',
    '动起来的瞬间（转身、撩发、回眸）最出片，多试几次～',
  ],
  // 服装搭配建议
  outfit_hint: [
    '穿纯色衣服在彩色背景前超上镜，试试看～',
  ...
  hair_tips: [
    ...
    '头发太贴头皮？用手轻轻拨松一下，增加蓬松感～',
    '长发披肩时让一侧头发垂在胸前，可以显脸小～',
    '发际线的碎发可以用手稍微按平，不要让头发太乱～',
    '有刘海的话注意不要让刘海挡住眼睛～',
    '头发在阳光下会有光晕效果，很美～',
  ],
  // ========== Round 迭代新增 ==========
  ...
  mirror_selfie_specific: [
    '对着镜子拍时手机稍微斜一点，避免镜面反光进镜头～',
    '镜子自拍让光打在脸上，正对镜子时脸上会有阴影，稍微侧身～',
    '浴室镜自拍光线最均匀！脸上的光会很通透～',
    '镜子自拍用后置镜头画质更好！对着镜子拍角度更好控制～',
    '镜子前拍照手机稍微倾斜，让镜面反射最少～',
    '找全身镜自拍时让人站在镜子三分线位置，构图更专业～',
  ],
  // ========== 本次新增：演唱会/舞蹈表演专属建议 ==========
  concert_dance_specific: [
    '演唱会灯光超有氛围！让灯光打在侧脸上，表情夸张灿烂～',
    '舞台灯光变化很快，提前对焦在脸上等时机按下快门～',
    '舞蹈表演抓拍时等动作到最高点或最有造型的瞬间～',
    '演唱会现场暗光手要更稳！靠在栏杆或找个支撑～',
    '舞台表演拍摄打开闪光灯会影响表演，开高ISO用现场光～',
    '表演时让人抬头或看镜头，表情清晰的时候抓拍～',
  ],
  // ========== 本次新增：游乐园/嘉年华专属建议 ==========
  carnival_amusement_specific: [
    '游乐园色彩丰富，背景太花会让主体不突出，开人像模式～',
    '摩天轮里光线超柔和，趁着车厢摆动到最稳的时候拍～',
    '过山车上抓拍表情超有活力！提前对焦在脸上～',
    '游乐园背景太杂乱，等人少时拍或开人像模式虚化背景～',
    '旋转木马光线均匀，趁机拍一张超有童话感～',
    '碰碰车场地光线偏暗，靠近光源或等光线好的时段再拍～',
  ],
  // ========== 本次新增：高铁站/机场/地铁站专属建议 ==========
  station_transit_specific: [
    '高铁站机场光线均匀，找个好看的出发层背景拍一张～',
    '站台光线冷调很有都市感，侧身靠着柱子超有范儿～',
    '候车大厅找个有设计感的角落，光线均匀很适合拍～',
    '地铁站灯光冷调，拍侧身照超有态度～',
    '站台背景有引导线构图，让人站在引导线交点上～',
    '机场出发层背景干净，找个广告牌或指示牌当前景～',
  ],
  // ========== 本次新增：天台白天专属建议 ==========
  rooftop_daytime_specific: [
    '天台白天光线充足！找个有阴影的角落，别让太阳直射～',
    '天台背景是城市天际线，侧身站着超有范儿～',
    '天台有风时拍动态抓拍，头发飘起来超灵动～',
    '正午天台阳光太硬，找建筑阴影处或等傍晚再拍～',
    '天台护栏可以做框架构图，围起来拍更有层次感～',
    '天台背景干净，构图时让人稍微偏离中心更有张力～',
  ],
  // ========== 本次新增：草原/牧场专属建议 ==========
  meadow_field_specific: [
    '草原上光线超通透！站在草丛中，笑着看镜头～',
    '草原逆光拍剪影超浪漫！转过身让阳光勾勒轮廓～',
    '牧场有栅栏或牛羊做道具，互动感更强～',
    '草原风大时等风停的瞬间拍，头发不会乱～',
    '草原上找一棵孤树做背景，构图立刻变电影感～',
    '草原阳光强，让脸稍微侧一点躲开强光～',
  ],
  // ========== 本次新增：商场自动扶梯专属建议 ==========
  escalator_specific: [
    '扶手电梯上光线冷调超有都市感，靠着扶手随意自然～',
    '电梯上不要摆拍，走动中的抓拍最自然～',
    '扶手电梯侧身靠着扶手，抬头看镜头超有气场～',
    '电梯快到顶层时按下快门，动态感十足～',
    '电梯扶手颜色鲜艳时，让它做前景增加层次感～',
  ],
  // ========== 本次新增：健身房专属建议 ==========
  gym_specific_suggest: [
    '健身房镜前光线均匀，侧身站着笑着拍一张超有活力～',
    '运动完后汗水让皮肤发光，趁这个状态拍一张超好看～',
    '器械区做动作时等最舒展的瞬间抓拍，表情也要自然～',
    '健身房镜子自拍用后置镜头，画质比前置好很多～',
    '动感单车时身体微微前倾，笑得灿烂看向镜头～',
    '健身后拉伸时姿态舒展，随意站着抓拍都好看～',
  ],
  // ========== Round 2 新增：通用多维度建议 ==========
  general_tips: [
    '下次试试跟着姿势模板站位，简单有效不费脑子～',
    '情侣照两个人靠近一点！贴贴更上镜～',
    '逆光场景打开 HDR 模式，高光阴影都能保留～',
    '人多的时候开人像模式，背景自动虚化，主体超突出～',
    '夜景拍摄找个光源（路灯/橱窗），脸不会黑黑的～',
  ],
}
