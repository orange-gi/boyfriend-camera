...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // 构图完美时正向强化
  composition_perfect_positive: [
    '构图满分！三分法稳稳拿捏，专业摄影师水平～',
    '人脸正好在视觉焦点上，这构图太讲究了！',
    '背景留白刚刚好，呼吸感十足，这张绝了！',
    '黄金分割点稳稳命中，这构图有大师感！',
    '视觉重心稳稳的，主体和背景关系处理得太棒了！',
  ],
  // 雨天窗户摄影（超热门的氛围感场景）
  window_rain_tip: [
  ...
  // 车内自拍
  car_selfie: [
    '车内光线通常偏暗偏蓝！靠窗户那边脸更亮，下回试试～',
    '车内空间小容易拍出大脸，稍微离远一点用后置镜头更好～',
    '车内反光多！穿深色衣服时尤其明显，开窗自然光更好看～',
    '车内拍的话打开天窗让自然光进来，效果会好很多～',
    '车内空间小怼脸拍会变形，离远一点或用后置镜头更好～',
  ],
  // 侧颜杀
  profile_shot: [
