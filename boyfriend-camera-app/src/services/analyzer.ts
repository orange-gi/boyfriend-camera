...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // 服装搭配专项建议（Round 2 扩展）
  clothing_color_tips: [
    '衣服颜色和背景太接近了！换个角度或背景，颜色对比会让主体更突出～',
    '服装和背景撞色了！稍微侧身躲开，或者换个角度让对比更明显～',
    '衣服和背景颜色接近，主体不够突出！下次穿对比色的衣服拍照效果更好～',
    '浅色衣服在浅色背景里会"消失"，换个深色背景或穿件对比色衣服试试～',
    // 2026-05-26 补充
    '红配绿虽然经典但要谨慎，同色系或邻近色更安全～',
    '黑色衣服在暗色背景里轮廓不够分明，适当补光或换背景～',
    '白色衣服容易过曝，拍照时稍微降低一点曝光补偿～',
    '彩色衣服配纯色背景是最不容易出错的组合～',
  ],
  // 发型建议
  ...
  subject_too_edge: [
    '人站到画面边缘了，往中间挪一挪会更稳～',
    '人太靠边了，稍微往中间站一点，构图会更平衡～',
    '脸被挤到边框了，往中间站一点，画面会更舒服～',
    '主体偏边了，稍微移到画面中间会更稳～',
    '人靠边框太近了，稍微往里站一步会更协调～',
    // Round 2 扩展：主体靠边建议池（5→8）
    '人物稍微往中间挪一点点，构图更稳，大片感更强～',
    '脸太靠近边缘了，稍微退后一步让脸居中，画面会更舒服～',
    '主体往中间移一点，两边留白均匀会更协调美观～',
  ],
  slight_look_away: [
  ...
  expression_stiff: [
    ...
    '深呼吸～表情会更放松自然，试试看～',
    '想象一件开心的事！表情马上就活起来了～',
    // Round 2 扩展：表情僵硬建议池（5→8）
    '表情稍微紧了一点，想想好笑的事，嘴角上扬会自然很多～',
    '脸部肌肉别绷着！舌尖轻轻顶住上颚，下巴线条更好看～',
    '肩膀沉下去，脖子伸长，表情自然舒展，这感觉对了～',
  ],
  // 新增：手势引导建议
  hand_pose_tips: [
    '手自然垂下就好，别紧贴身体，侧面会更显瘦～',
    '双手叉腰！这个姿势显瘦又有气场～',
    '手指轻轻合拢，比张开更优雅～',
    '一只手托腮，显脸小的经典 pose～',
    '手臂稍微离开身体，侧面会更显瘦～',
    // Round 2 扩展：手势引导建议池（5→8）
    '双手轻轻搭在肩上，慵懒又优雅，试试看～',
    '手放头顶，比个耶或比个心，活泼感立刻上来～',
    '手指轻轻捏住下巴位置，显脸小的同时表情也更自然～',
  ],
  food_scene_specific: [
  ...
  golden_hour_photo_tips: [
    ...
    '现在光线每秒都在变美！抓紧时间多拍几张～',
    '日落前半小时光线最暖！趁现在多拍几张侧脸照～',
    '逆光拍完再转过来拍一张正面，光影层次会更丰富～',
  ],
  // 多人合照构图建议
  ...
  // 健身房镜子自拍建议
  gym_mirror_tips: [
    '健身房镜子自拍！侧身站着举哑铃，肌肉线条和笑容同框超有活力～',
    '对着镜子找好角度，光线从侧面打进来最有立体感～',
    '穿亮色运动服在健身房镜子前超显眼，颜色鲜艳更上镜～',
    '健身房镜子前光线一般较硬，稍微侧身躲开顶灯阴影会更干净～',
    '运动出汗后皮肤通透！这个状态拍照超好看，赶紧抓拍～',
    '动感单车旁光线好！侧身站着，让侧光勾勒身体线条～',
    '瑜伽垫上躺着俯拍，超显脸小！这个姿势绝了～',
  ],

  // 白天露台拍照建议
  rooftop_daylight_tips: [
    '白天露台光线充足！找个有遮挡的角度，别让强光直射脸～',
    '露台背阴处光线最柔和！站在阴影边缘拍，光影超有层次～',
    '露台有城市天际线做背景！侧身站着，让背景延伸感拉满～',
    '中午强光下露台拍照容易过曝，等云遮一下或找阴影处～',
    '露台有栏杆做道具！扶着栏杆侧身看远方，超有氛围～',
    '露台有花有绿植！靠近花草站着，自然感立刻加分～',
    '风大的时候露台头发容易乱！等风停了再按快门～',
  ],

  // 火车窗边拍照建议
  train_window_tips: [
    '火车窗边光线均匀！侧身靠着窗，让自然光打在侧脸上～',
    '车窗有反光！稍微侧身躲开玻璃反光，脸会更干净～',
    '火车移动时窗外风景是动态背景，抓拍窗外再转回来看镜头～',
    '车窗可以做框架构图！透过车窗拍人，层次感绝了～',
    '火车窗边光线偏冷白，后期可以加一点暖色调更温柔～',
    '卧铺车厢有小桌板，放一杯咖啡当道具，超有旅行感～',
    '高铁车窗干净透亮，透过窗拍人像超有电影感～',
  ],

  // 博物馆画廊拍照建议
  museum_gallery_tips: [
    '博物馆画廊光线偏暗！打开手机补光灯或靠近展品光源～',
    '画廊白墙可以做极简背景！正面站直超有高级感～',
    '名画雕塑前侧身站立，让艺术感和人融为一体～',
    '博物馆禁止闪光灯！尽量靠近光源或调高手机亮度～',
    '画廊灯光打在画作上会反射！侧一点身躲开反光～',
    '站在画作旁边假装欣赏，侧头微笑，文青感拉满～',
    '博物馆人多！等人群走开再拍，或者开人像模式虚化背景～',
  ],

  // 节日灯展/灯会拍照建议
  festival_lantern_tips: [
    '灯展灯光斑斓！让光打在侧脸上，别让灯直射眼睛～',
    '灯串做前景超浪漫！让灯串在镜头前虚化成光斑～',
    '灯展一般晚上拍，打开闪光灯正面补光，不然脸太暗～',
    '灯展人多！开人像模式虚化背景，或者蹲低一点拍～',
    '灯展颜色丰富！穿纯色衣服更显主体，不被背景淹没～',
    '灯展有倒影更好看！找水坑或反光地面蹲低拍～',
  ...
  // 泳池边拍照建议
  pool_side_tips: [
    '泳池边光线充足！阳光从水面反射上来，皮肤看起来超通透～',
    '泳池边地面湿滑！小心走稳，防止手机掉水里～',
    '坐在泳池边脚浸在水里，超有夏日感！赶紧拍～',
    '泳池水会反射阳光造成脸上亮斑，侧身躲开水面反光～',
    '戴着墨镜站在泳池边，超酷！摘下墨镜的一瞬间抓拍～',
    '泳池边有躺椅！靠在躺椅上慵懒看镜头，超有度假感～',
    '下午三四点泳池光线最柔！比正午好拍多了～',
  ],

  // 雪天拍照建议
  snow_weather_tips: [
    '雪地光线反射极强！戴墨镜保护眼睛，或者眯眼笑～',
    '雪地白茫茫一片，穿鲜艳衣服才不会被背景吞没～',
    '雪天皮肤容易泛红！等进室内暖一下再拍，或者加滤镜～',
    '雪地脚印可以做引导线！顺着脚印走向镜头，画面有延伸感～',
    '雪天手机电池掉电快！贴个暖宝宝防止自动关机～',
  ...
  // 秋季红叶拍照建议
  autumn_foliage_tips: [
    '红叶背景下侧身站立！让落叶飘在头发上，秋冬感拉满～',
    '秋天下午三四点光线最柔！侧逆光让发丝发光～',
    '地上落满红叶可以躺下来俯拍，超有秋冬氛围感～',
    '红叶做前景虚化，透过叶子拍人，层次感绝了～',
    '穿驼色、米白色衣服和秋景最搭，别穿太艳的颜色～',
    '枫叶树下仰拍，让树叶填满背景，颜色超丰富～',
    '傍晚夕阳打在红叶上，金红色光线绝了！赶紧拍～',
  ],

  // 毕业典礼拍照建议
  graduation_ceremony_tips: [
    '毕业典礼人多！找个角落或等人群散开再拍～',
    '毕业袍配高学位帽，帽穗甩到一边超有范儿～',
    '抛学位帽的瞬间连拍！跳起来或原地抛，精彩瞬间别错过～',
    '毕业典礼一般在室内，光线偏暗，打开闪光灯补光～',
    '和同学排成一排，背后是校门或教学楼，超有仪式感～',
    '毕业袍一般比较宽松，收一下腰或者系上皮带更显瘦～',
    '拍完正脸再拍背影，背对镜头看镜头，超有毕业感～',
  ],

  // 动物园/水族馆拍照建议
  zoo_aquarium_tips: [
    '动物园光线复杂！靠近围栏或玻璃找光源～',
    '水族馆蓝色光线超梦幻！侧身站着让蓝光打在侧脸上～',
    '隔着玻璃拍容易反光！镜头贴着玻璃拍可以减少反光～',
    '动物园人多！开人像模式虚化背景，主体更突出～',
    '和小动物互动时蹲下来平视，角度更有亲和力～',
  ...
  supermarket_tips: [
    ...
    '便利店的冰柜前光线偏冷白，侧身躲开冷光正面拍摄～',
    '货架前背景有点乱，打开人像模式虚化背景～',
    '超市零食当道具超可爱！拿起来对着镜头笑一个～',
    '便利店的自动门光线变化大，等门关上再拍～',
  ],
  // ===== 2026-05-25 新增建议池 =====
  // 对称构图专属建议
  ...
  // 眼镜反光处理建议
  glasses_reflection_hint: [
    '镜片反光挡住眼神了！稍微侧一下脸躲开光源～',
    '眼镜反光太明显了！换个角度让光打在镜片侧面～',
    '镜片里映出了手机！稍微抬一下头或侧一下脸，反光就不见了～',
    '镜片反光让眼睛看起来像蒙了一层雾！抬头或低头调整一下角度就好～',
    '镜片中映出相机了！稍微抬头或偏一下角度，反光立刻消失～',
    '眼镜反光让眼神看起来不清晰，侧一下头躲开直射光试试～',
  ],
  // 逆光发丝光专属建议
  backlight_hair_light: [
    '逆光发丝光超美！但脸太暗了，稍微转过来让光打在脸上～',
    '头发边缘的光晕好美！就是脸太黑了，打开闪光灯补补光～',
    '这张逆光很有氛围！但为了拍到你的脸，转过来一点点就好啦～',
    '逆光发丝光美翻了！脸稍微转过来一点，正面有光眼睛更灵动～',
    '逆光轮廓光绝了！但正面光不够，让男朋友打开闪光灯补光～',
    '发丝光超仙！但脸太暗了，转过来让光打在脸上更完美～',
  ],
  // 纹理细节专属建议
  texture_detail_hint: [
    '皮肤纹理清晰可见，细节表现很棒！光线再柔和一点会更完美～',
    '这张细节很丰富！但脸上高光有点过了，换个角度躲开强光～',
    '纹理细节抓得不错！就是光稍微硬了一点，下次试试柔光～',
    '柔光下皮肤质感超细腻！阴天或窗户边光线最柔和，试试看～',
    '皮肤质感表现很好！靠近窗户的柔光会让细节更通透～',
    '纹理清晰皮肤细腻！但嘴角阴影有点重，侧一下脸光会更均匀～',
  ],
  // 滤镜匹配建议
  filter_tip: [
    '暖色调滤镜配美食和夕阳最搭，这张用暖黄滤镜会更诱人～',
    '人像用柔和或人像滤镜会更自然，这张可以试试～',
    '电影感滤镜配城市夜景绝了，试试 cinematic 滤镜～',
    '美食照用暖色调更诱人，这张换个滤镜效果会更好～',
    '黑白滤镜配建筑和文艺场景最有感觉，试试 bw 滤镜～',
    '柔和滤镜配室内日常和闺蜜照最搭，皮肤看起来超细腻～',
    '冷色调滤镜配蓝天白云和雪景超有氛围感，这张试试～',
    '生动滤镜配户外风景和运动场景超有活力，这张绝了～',
    '情侣照用暖黄或人像滤镜最浪漫，这张绝了～',
    '夜景用电影感滤镜，霓虹灯光会更有氛围感～',
    '阴天光线偏冷白，加一点暖色调滤镜皮肤会更通透～',
  ],
  // 情绪引导建议
  emotion_lacking_tip: [
  ...
  hand_face_occlusion: [
    ...
    '手离脸太近了！稍微离开一点，比例会更协调～',
    '手指并拢比张开更优雅！试试手指轻轻合拢放在脸旁边～',
  ],
  // v5 新增：玻璃反光 / 镜面拍摄建议
