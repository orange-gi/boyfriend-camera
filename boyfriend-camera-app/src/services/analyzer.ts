...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // 多人合照时有人闭眼
  group_eye_closed: [
    '合照里有人的眼睛闭了！下次拍照前喊"田七"，大家同时睁眼～',
    '这张有人的眼睛闭了，合照时让男朋友多拍几张选最好的～',
    '合照眨眼了！告诉朋友们拍照时说"茄子"，嘴巴张开眼睛自然睁开～',
    '闭眼被抓到了！合照时用连拍模式，多拍几张总能挑到完美的～',
    '有人的眼睛闭了！告诉朋友们"一二三"喊到三时一起睁眼～',
    '合照里有人闭眼了！多拍几张让大家都睁大眼睛～',
  ],
  // 手部姿势引导
  hand_gesture_tips: [
    '手不知道往哪放？叉腰是最显瘦的经典姿势～',
    '双手自然垂下就好，别紧贴身体，稍微打开一点更显瘦～',
    '比个耶！经典手势永不过时，活泼可爱～',
    '试试托腮！一只手轻轻托在下巴上，气质立刻提升～',
    '手插口袋露出一点手指，休闲又有型～',
    '双手举起来！跟着节奏动起来，活力满满～',
    '撩一下头发！自然的动作最有氛围感～',
    '把手放在胸前或腰间，优雅又有气质～',
  ...
  // 镜头眩光
  lens_flare_tips: [
    '有眩光了！让光源稍微移出画面边缘，减少镜头光晕～',
    '眩光让照片有点雾蒙蒙的，让男朋友稍微调整一下角度躲开阳光～',
    '镜头眩光很酷但也有点糊，让光源偏出画面试试～',
    '眩光有点强！换个角度让太阳在画面外，照片会更清晰～',
    '光晕效果还不错！如果想更清晰，稍微遮挡一下光源～',
    '眩光让照片有种朦胧美！如果想要更清晰的画面，躲开直射阳光～',
  ],
  // 新增：情侣照专属建议
  couple_tips: [
    ...
    '情侣照背景要干净，这样两个人才最突出～',
    '男生从背后环抱女生，这个姿势超有爱～',
    '两人一起看镜头，笑得灿烂点，这张照片要发朋友圈！',
    '试试闭眼享受风吹的感觉，男朋友从正面抓拍～',
    '两人背对镜头牵手，简约又甜蜜，让男友从背后拍～',
    '女生侧头靠在男生肩上，这个角度超甜～',
  ],
  // 新增：近距离特写建议
  close_up_tips: [
    '怼脸拍皮肤质感满分！但表情要放松才好看～',
    '近景特写光线要均匀，侧光让五官更立体～',
    '近距离拍时表情要自然，放大看都经得起考验～',
    '特写眼睛超有神！让女朋友眼睛看镜头，电力十足～',
    '近拍时稍微抬头，下巴会更尖一点，轮廓更好看～',
    '特写可以捕捉到睫毛和发丝的细节，这张绝了！',
    '近距离拍要注意表情管理，放大后每个细节都看得到～',
  ],
  // 新增：全身照建议
  full_body_tips: [
    '全身照要让整个人都完整入镜，头顶留白三分之一～',
    '拍全身时站姿很重要！一脚前一脚后，重心稳了姿态就自然～',
    '全身照背景要干净简洁，这样人物才突出～',
    '拍全身时让男朋友蹲低一点从下往上拍，秒变大长腿！',
    '全身照脚不能截掉，头顶留白大概三分之一最舒服～',
    '全身照如果人多背景乱，开大光圈虚化背景更好看～',
    '拍全身站立照时让女朋友一只脚往前伸，显腿长～',
  ],
  // 新增：配饰道具建议
  accessories_tips: [
    '帽子是很好的道具！戴帽子拍照可以遮住乱的发型～',
    '太阳镜超适合户外拍照，摘下来的一瞬间抓拍超自然～',
    '围巾或披肩可以增加层次感，让画面更丰富～',
    '小背包或手提袋都是很好的道具，让手有地方放～',
    '拿一杯饮料或一本书，自然感立刻加分～',
    '花朵或树叶都是现成的道具，让女朋友捧着拍～',
    '道具不要太多，一个就够，太多会分散注意力～',
  ],
  // 新增：背景简洁度建议
  background_tips: [
    '背景太杂乱了！找个干净简洁的背景让人物更突出～',
    '背景里电线杆/垃圾桶等杂物太多了，挪一挪位置再拍～',
    '找面纯色的墙或者干净的天空当背景，超容易出片～',
    '背景太乱时走近一点，大光圈虚化背景立刻干净～',
    '户外拍照时背景太乱，试试仰拍让天空当背景～',
    '打开人像模式虚化背景，主体立刻突出～',
    '背景和人距离越远虚化越明显，让人站远一点再试试～',
    '找延伸线背景（如道路、走廊）可以让照片更有纵深感～',
  ],
  // 新增：拍摄角度建议
  angle_tips: [
    '稍微蹲低一点从下往上拍，显腿长！',
    '手机举高一点俯拍，可以让脸显得更小～',
    '从侧面45度角拍比正脸更显瘦，试试这个角度～',
    '仰拍时让女朋友抬头看镜头，下巴会更尖～',
