...
const PRAISE_POOL: Record<string, string[]> = {
  ...
  silhouette_praise: [
    '逆光剪影绝了！轮廓感拉满，这张好有意境～',
    '剪影拍出了艺术感，男朋友你这角度选的太好了！',
    '背光剪影超有氛围感，整个人都在发光的感觉！',
    '逆光轮廓光太美了，这张像电影海报！',
  ],
  // 倒影专属夸奖（水面/镜子）
  reflection_praise: [
    '水面倒影超美！对称构图绝了，这张好有意境～',
    '倒影让这张照片层次感翻倍，男朋友你有创意！',
    '镜面倒影和本人同框，画面感满分！',
    '水面反射超有氛围，这张像杂志大片！',
  ],
  // 黄金时段专属夸奖
  golden_hour_praise: [
    '黄金时段光线绝了！这光打在脸上好温柔～',
    'Golden Hour 光线好美，这张有专业感！',
    '日落光线超暖，男朋友你把女朋友拍成了电影主角！',
  ],
  // 蓝调时刻专属夸奖
  blue_hour_praise: [
    '蓝调时刻超有氛围感！天色和灯光形成冷暖对比，绝了～',
    'Blue Hour 拍出了都市感，这张好有质感！',
    '蓝调时刻光线独特，这张像电影截图！',
  ],
  // 完美构图专属夸奖（高构图分 + 无明显问题）
  composition_master_praise: [
    '构图教科书级别！男朋友你是有天赋的吗？',
...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  blurry: [
    ...
    '这张有点糊，让男朋友双手握稳手机再按快门～',
    '光线太暗容易糊片，找个亮一点的地方重新拍～',
    '按快门时手别抖，深呼吸，轻轻一点就好～',
    '拍完放大检查一下，糊了就重拍，别留遗憾～',
    '移动中拍照容易糊，停下来站稳再按快门～',
  ],
  ...
  symmetry_composition: [
    '正面站直试试！对称构图超有气场，建筑物背景尤其适合～',
    '试试正对镜头站直！对称感会让照片更有仪式感～',
    '这个场景适合对称构图！身体站直，眼睛平视前方～',
    '对称构图显得端庄大气！脚踩引导线站正中，画面稳如磐石～',
    '建筑、镜子、水面倒影都是对称构图的好场景，试试脚踩中线站～',
    '镜子自拍天然对称！侧身对着镜子，角度刚刚好就是大片～',
  ],
  // 引导线构图专属建议
  leading_line: [
    '找一条引导线！道路、栏杆、墙壁都能引导视线到人身上～',
    '背景里有引导线！让女朋友站在引导线汇聚点上，构图会超有层次～',
    '这张可以用引导线构图！让视线自然汇聚到主体上，照片会更有深度～',
    '楼梯扶手、围栏、河流、道路边缘都是天然的引导线，让人站在末端～',
    '引导线从画面边缘延伸向主体，照片会自带纵深感，像专业摄影师拍的～',
    '斜着的引导线比垂直的更有动感，试试让引导线从角落伸向主体～',
  ],
  // 留白构图专属建议
  negative_space: [
    '多留一点空白！留白让画面更透气，也有更多呼吸感～',
    '背景留少一点试试！让主体占比更大，画面更饱满有力～',
    '留白是一种艺术！空的地方和主体同样重要，能增加照片的故事感～',
    '天空、大海、大片纯色墙都是极简留白的好背景，让人占三分之一即可～',
    '留白不是浪费空间，是给视线喘息的地方，照片会更耐看～',
    '试试把人放在画面边缘，留出大量空白，反而更有意境和想象空间～',
  ],
  // 眼镜反光处理建议
  // 逆光发丝光专属建议
  // 纹理细节专属建议
  ...
  // 画廊/展览馆专属建议（文艺场景）
  gallery_exhibition_specific: [
    '画廊找纯色背景！白墙或单色墙让人物更突出～',
    '展品前侧身站，让艺术作品和人物同框，超有文艺感～',
    '画廊光线偏暗，打开闪光灯补光，或者靠近聚光灯站立～',
    '展馆内不要开闪光灯会影响其他观众！靠近灯光展示区让脸亮起来～',
    '画廊建筑线条感强！利用走廊纵深构图，人物居中更有张力～',
    '展品前的侧逆光勾勒轮廓超有氛围，试试看～',
  ],
  // 桥上夜景专属建议
  starry_night_specific: [
    '星空夜景要长曝光！手机拿稳了不要动，三脚架更佳～',
    '星空拍摄背景很暗，男朋友要站在灯光下或打开闪光灯补光～',
    '星空夜景后期可以稍微提亮人脸，让主体更突出～',
    '星空拍摄要选没有月亮的时间段，星星才够亮～',
    '星空下打开闪光灯照亮人脸，星光和人同时保留～',
    '用手机专业模式调低 ISO、延长快门，星空会更清晰～',
  ],
  // 雾凇/冰挂专属建议
  frost_ice_specific: [
    '雾凇树枝做背景超有层次！侧身站着让冰挂衬托人物～',
    '冰挂场景光线偏冷白，后期可以加一点暖色让肤色更健康～',
    '冰面反射强容易过曝，稍微降低曝光补偿～',
    '雾凇天气光线柔和！脸上的光会很均匀，抓紧拍～',
    '雪地里拍红色衣服超抢眼！白色背景配红色点缀，视觉冲击力满分～',
    '冰挂晶莹剔透，侧身让光从背后透过来，超有意境感～',
    '雪景光线反射强容易过曝，适当降低曝光补偿让雪不过曝～',
  ],
  // 夕阳剪影专项建议
  silhouette_specific: [
    ...
    '剪影拍摄时让身体侧对镜头，轮廓线条会更修长～',
    '日落时分的剪影最有层次！抓住Golden Hour的尾巴～',
  ],
  // 秋季红叶专项建议
  autumn_leaves_specific: [
    '红叶做背景超有秋意！侧身站着让叶子衬托人物～',
    '秋季光线柔和！红叶和肤色配合超美，抓紧拍～',
    '逆光透叶光斑超有意境！让阳光穿过树叶打在脸上～',
    '秋天光线偏暖，后期可以适当降温让红色更纯净～',
    '红叶落在地上可以当前景道具，低角度拍超有层次感～',
    '秋天金色光线最美！抓住下午三四点的黄金时段～',
    '红叶配浅色衣服超上镜！让男朋友蹲下来仰拍，背景全是红叶～',
  ],
  // 商场/步行街场景建议
  shopping_street_specific: [
    '商场橱窗灯光超有都市感！侧身让橱窗光勾勒轮廓～',
    '步行街人多背景杂，等人少的时候抓紧拍～',
    '商场光线偏白/偏蓝，打开屏幕补光让肤色更自然～',
    '步行街找面干净的橱窗玻璃，当镜子自拍也很有质感～',
    '傍晚的步行街灯光刚亮，侧身让霓虹灯光打在侧脸超有氛围～',
    '商场楼梯或扶梯旁光线均匀，适合拍半身人像～',
    '步行街橱窗玻璃反光很强，让男朋友站在反光面拍，画面更有层次～',
  ],
  // 正向引导：光线完美时强化鼓励
  lighting_perfect_positive: [
    '光线刚刚好！皮肤通透有质感，继续保持这个角度～',
    '脸上的光好均匀！这角度绝了，这张肯定高分～',
    '光源方向完美！立体感十足，男朋友你是专业的吗～',
    '侧光勾勒出脸部轮廓，这光影绝了！',
    '柔光环境下肤色好通透，这光线简直是老天爷帮忙～',
    '明暗对比刚刚好，这光影效果像杂志大片！',
  ],
  // 构图完美时正向强化
  window_rain_tip: [
  ...
  // 地铁夜间/地下场景建议
  metro_night_specific: [
    '地铁站灯光偏暗偏冷！找靠近灯光展示区的位置，让脸正对光源～',
    '地铁站台光线复杂，开闪光灯补面部光线效果最好～',
    '地铁里镜子玻璃可以当道具！对着镜子拍，超有都市感～',
    '地铁站灯光偏青冷调，靠近窗户或灯光充足处脸会更亮～',
    '地下空间光线偏暗，打开闪光灯补光或靠近光源更亮的地方～',
    '地铁站台等车时侧身站，灯光打在侧脸上层次感更好～',
    '地铁出口光差大，等眼睛适应后再拍，避免脸太黑或过曝～',
    '地铁站找块干净的墙做背景，比杂乱的设施更显气质～',
  ],
  // 春日花园/踏青场景建议
  spring_garden_specific: [
    '春日花园光线超通透！站在花丛中，笑着看镜头～',
    '春天逆光拍发丝发光绝了！让阳光从背后打过来，超唯美～',
    '樱花/桃花季光线斑驳！风吹过来的时候按下快门，花瓣和笑容一起定格～',
    '春季户外光线好的时候，正面或侧光都很出片，不用担心过曝～',
    '春日户外找干净的花丛或草地做背景，人物居中或三分都很好看～',
    '春季户外光线偏暖，后期稍微降降色温会更自然～',
    '春天踏青拍花草超有生机感！蹲低仰拍让花做背景超浪漫～',
    '春日草地光线柔和，适合拍躺姿或坐姿，人物和草地融合超治愈～',
  ],
  // 镜面/倒影摄影建议（2026-05-28 扩展）
  mirror_photo_specific: [
    '对着镜子自拍时手机稍微倾斜一点拍，避免正面正对镜子有反光～',
    '浴室镜前光线均匀超显气质，侧身45度笑一个～',
    '镜子反光太强时用衣服遮一下闪光灯，或者侧身躲开反光～',
    '全身镜自拍要拍到脚尖，让男朋友确保镜子里能看到脚，腿会更显长～',
    '镜子太大时只拍上半身，让男朋友站远一点取更完整的角度～',
    '对着镜子拍时让男朋友站在镜子外侧拍，手机不用入镜更干净～',
    '竖镜拍竖图，横镜拍横图，换个方向构图更有变化～',
    '选择干净的镜子背景！脏镜子会让画面大打折扣～',
  ],
  // 健身房镜子自拍建议
  gym_mirror_specific: [
    '健身房镜子自拍要斜着拍，避免镜面反光～',
    '健身完对着镜子自拍！抓拍最有感觉，镜子里的状态最自然～',
    '动感单车区光线好！跳下来对着镜头笑一个～',
    '举哑铃时侧身对着镜子拍，肌肉线条和笑容同时入镜超有活力～',
    '瑜伽垫上做姿势时俯拍，从上往下捕捉舒展的瞬间～',
    '健身房镜子自拍时注意别拍到身后的其他器械，背景太乱会分散注意力～',
    '穿亮色运动内衣更上镜！白色或粉色超显活力，运动感十足～',
    '健身房镜子前做动作时表情要放松，笑着比严肃更有感染力～',
  ],
  // 泳池/水边场景建议
  pool_water_specific: [
    '泳池边逆光拍超有氛围！转过身让光打在脸上，肤色通透～',
    ...
    '泳池水波粼粼时侧身拍，水光反射在脸上层次感超丰富～',
    '水边拍照时稍微侧身，让水面的反射光打在侧脸上更立体～',
    '水边风大时等风停的瞬间拍，头发和裙摆飘起来的动态感超美～',
  ],
  // 雨天窗户摄影建议
  window_rain_specific: [
    '雨天窗户光线超柔和！在窗户边拍皮肤状态超好～',
    '雨滴落在玻璃上很有氛围感，可以利用这个元素～',
    '雨天光线偏暗偏柔，可以靠近窗户或开灯补光～',
    '雨伞也是很好的拍照道具！撑伞站着超有感觉～',
    '雨后玻璃上有水珠时拍特写，朦胧感很加分～',
    '雨天室内注意白平衡！偏暖的灯光和冷调窗外形成对比更有氛围～',
    '雨天拍摄等公交车，玻璃上的雨滴超有电影感～',
    '玻璃上有雾气时用手指写字超浪漫！趁雾气还在赶紧拍一张～',
    '雨天的散射光超柔和，拍出来的皮肤状态比晴天还好～',
    '雨天光线偏冷白，后期加一点暖色调会更温暖～',
  ],
  // 游乐场飞椅/嘉年华专项建议
  carnival_ride_specific: [
    '游乐场飞椅动感十足！飞椅旋转时抓拍表情最自然～',
    '旋转飞椅上海风扑面！裙摆飞扬的瞬间按下快门，动感十足～',
    '摩天轮转到最高点时俯拍城市，背景超开阔～',
    '碰碰车场地灯光闪烁，抓拍被撞瞬间的表情超有趣～',
    '过山车尖叫瞬间超生动！抓拍表情最自然～',
    ...
    '游乐场纪念品店前光线充足！靠着橱窗拍超有氛围～',
    '跟着节奏动起来时抓拍，表情最生动自然～',
    '游乐场夜间灯光璀璨，打开闪光灯补光让人脸更清晰～',
  ],
  // 节日灯展/灯会专项建议
  festival_light_night_specific: [
    '灯展场景色彩斑斓！侧身站着让灯打侧脸上，超有氛围～',
    '灯串做前景虚化超美！让灯串靠近镜头，人在后面超有氛围～',
    '灯展背景五彩缤纷，衣服选纯色更突出主体～',
    '节日彩灯下拍剪影也超浪漫！背对灯光让轮廓发光～',
    '灯展人多时等一等，等人走过去再拍，或者开人像模式虚化背景～',
    '灯展光串可以做眼神光！让女友侧身站，灯串光反射到眼睛里～',
    '节日灯光颜色丰富，开闪光灯正面补光避免肤色被彩光照得太花～',
    '灯展背景过曝时稍微压低一点曝光，灯光才不会被吃掉～',
  ],
  // 运动/动态摄影专项建议
  motion_photo_specific: [
    '跑跳瞬间最容易出好照片！按住快门连拍别松手～',
    '跑跳时对焦点要一直追着人脸，连拍更容易出好片～',
    '追焦拍摄时对焦在眼睛上，连拍捕捉最清晰的一帧～',
    '边跑边拍会让画面更动感，但也更容易糊，稳一点效果更好～',
    '动态抓拍建议用连拍模式，多拍几张选最好的～',
    '运动中拍糊了？打开夜景模式或找光源更亮的地方～',
    '跑跳跟拍时步伐要稳，摄影师和被拍者同步移动更易出片～',
    '跑跳姿势时让女朋友先做准备动作，男朋友准备好再开始跳～',
  ],
  // v8 新增：眼睛紧闭专项建议
  eyes_closed_tight: [
    '眼睛闭太紧了！睁开一点点，眼神会更灵动～',
    '两只眼睛都紧紧闭着，提醒她稍微睁开一点，照片会更有神～',
    '闭眼提示：眼睛闭太紧会让表情显得僵硬，稍微睁开会更自然～',
    '闭眼时眼睛周围肌肉太紧，试试轻轻睁开，表情会更放松～',
    '闭眼笑的时候提醒她：眼睛轻轻眯着就好，不用完全闭上～',
    '让女朋友回忆一件开心的事，自然微眯眼睛比用力闭眼更好看～',
    '闭眼时可以试着只闭一半眼皮，微微露出眼神更有意境～',
  ],
  // v8 新增：手挡住镜头提示
  ...
  camera_angle_extreme: [
    '这个角度有点太仰了，试试稍微降低一点镜头高度～',
    '镜头太俯了，显得下巴很短，稍微抬高一点点～',
    '机位角度有点极端，试试平视或稍微调整一下～',
    '男朋友的拍摄角度有点夸张，稍微正常一点会更自然～',
    '俯拍显脸小的黄金角度是手机在正上方约15-20cm，略微俯一点即可～',
    '仰拍时让女朋友微微低头收下巴，脸会更显小，角度也不会太夸张～',
    '情侣合照时手机稍微高一点平拍，两个人都能入镜，角度也自然～',
  ],
  // v8 新增：背景完全无光提示
  ...
  // Round 2 新增：露营篝火场景建议
  campfire_camp_specific: [
    '篝火火光打在脸上超有氛围感！让火光映照侧脸，表情会更柔和～',
    '露营帐篷前光线超美！让帐篷做背景，人站前面笑一个～',
    '篝火旁拍完赶紧回帐篷暖和，别让女朋友冻太久～',
    '露营光线不足，篝火或营地灯补光时脸不要离火太近，避免过暖～',
    '夜晚露营时打开手机闪光灯补光，让脸和背景同时清晰～',
    '篝火火光偏暖色，后期可以稍微降温让肤色更自然～',
  ],
  // Round 2 新增：火车旅行场景建议
  train_journey_specific: [
    '火车车窗自然光超柔和！侧身靠着窗边，让光打在侧脸上～',
    '车厢内光线偏暗，找靠窗位置让自然光进来～',
    '火车旅行拍窗外风景时，让女友做前景虚化，画面更有层次～',
    '站台停靠时抓拍！车窗外光线刚好，表情自然又生动～',
    '火车行进中拍窗外！速度感强，背景流动的照片超有故事感～',
    '候车大厅找落地窗边站，光线均匀拍人像最合适～',
  ],
  // Round 2 新增：涂鸦墙/街头艺术场景建议
  graffiti_street_specific: [
    '涂鸦墙背景色彩丰富！让人穿纯色衣服，主体更突出～',
    '街头涂鸦背景杂乱时，开大光圈虚化背景，主体更突出～',
    '色彩斑斓的涂鸦墙当背景，衣服选黑白灰最安全～',
    '涂鸦墙前侧身站，让彩色背景衬托人物更生动～',
    '街头艺术背景光线复杂，开闪光灯正面补光避免偏色～',
    '找一面干净的涂鸦墙！颜色饱和度高的墙配纯色衣服，超有感觉～',
  ],
  // Round 2 新增：摩天轮场景建议
  ferris_wheel_specific: [
    '摩天轮转到顶端时俯拍城市，背景超开阔～',
    '摩天轮包厢空间小，男朋友拿手机伸出去拍效果更好～',
    '摩天轮里光线偏暗，打开屏幕补光让脸亮起来～',
    '摩天轮转到最高点时俯拍，人物居中背景城市超有感觉～',
    '转动的瞬间抓拍表情最自然，连拍几张选最好的～',
    '摩天轮玻璃会反光，稍微侧身躲开反光～',
  ],
  // 户外情侣合照专属建议
  couple_outdoor: [
    '户外情侣照！让男生从背后环抱，两人看向远方～',
    '情侣牵手背影超有感觉！背对镜头牵手走，抓拍这个瞬间～',
    '两人坐在草地上，头靠在一起笑着看镜头～',
    '户外阳光好！侧逆光拍情侣，发丝发光超浪漫～',
    '两人对视的瞬间抓拍，表情自然又甜蜜～',
    '坐在长椅上，两人靠在一起，笑着看镜头～',
    '两人面对面站着，轻轻碰额头，超甜的姿势～',
    '男生公主抱！户外阳光灿烂，这个姿势超有活力～',
    '两人牵手原地转圈，动态抓拍最生动～',
    '户外找一面干净的白墙做背景，情侣照更显高级～',
  ],
  // 窗边人像专属建议
  window_portrait: [
    '窗边自然光最柔和！让人靠近窗户，皮肤看起来超好～',
    '侧身面对窗户，光影打在侧脸上最有立体感～',
    '逆光剪影也很有意境！让光勾勒轮廓，背景是窗外的光～',
    '阴天的窗边光线均匀柔和，是人像拍摄的黄金位置～',
    '早晨窗边的光线偏暖，拍摄元气少女感绝了～',
    '窗边拍摄时，背景选择干净的墙面，画面更简洁～',
    '玻璃反光太强时，稍微侧身躲开反光～',
    '雨天窗边超有氛围感！水珠在玻璃上，画面感十足～',
  ],
  // 冬季雪景专属建议
  winter_snow: [
    '雪地光线反射强容易过曝！稍微降低一点曝光补偿～',
    '围巾是天然的暖色反光板，把脸衬得红润通透～',
    '白茫茫的背景超浪漫！稍微过曝一点白雪才不灰～',
    '雪景里的彩色围巾超好看，是加分项哦～',
    '雪地仰拍要小心！别让雪进到眼睛里～',
    '雪天拍完赶紧回室内暖和，别让模特冻太久～',
    '雪天穿亮色衣服更突出主体，白色衣服小心与背景混在一起～',
    '雪地反射紫外线强，戴墨镜或找阴影避免眯眼～',
  ],
  // 倒影/镜面摄影专属建议
  reflection_photo: [
    '地面水洼有倒影！蹲下来俯拍，倒影和人都入镜～',
    '玻璃橱窗也能当镜子用，找好角度躲开反光～',
    '找一块干净的反光面，俯拍时倒影和人会形成对称构图～',
    '水面倒影需要慢门或稳定手机，打开连拍抓一张～',
    '镜子拍摄时把手机稍微侧一点，躲开自己和镜中像重叠～',
    '玻璃反光时要斜着拍，躲开周围的杂乱环境～',
    '找地面的积水或水坑，俯拍倒影构图超有艺术感～',
    '阳光明媚时水面反光最强，这个时间段拍倒影最清楚～',
  ],
  // 秋季红叶专属建议
  autumn_leaves: [
    '红叶背景下光线斑驳！风吹过来的时候按下快门，绝美～',
    ...
    '红叶背景颜色很鲜艳，衣服选浅色更突出主体～',
    '蹲低仰拍让叶子落在头顶上方，超有氛围感～',
    '逆光红叶透光超美！让阳光从背后打过来，叶子会发光～',
    '找一片干净的红叶区域，让人站在中间构图更简洁～',
    '秋日阳光和红叶搭配，暖色调滤镜效果超棒～',
  ],
  // 黄金时刻专属建议（独立于 blue_hour_specific）
  golden_hour_specific: [
    '黄金时刻的阳光是暖橙色，打在侧脸上超有质感～',
    '日落前半小时是黄金时刻，光线最柔和最暖～',
    '黄金时刻逆光拍发丝光，让阳光从背后打过来～',
    '黄金时刻拍剪影超美！让轮廓发光，背景是暖橙色的天空～',
    '黄金时刻侧逆光最有层次，让光打在侧脸和肩膀上～',
    '这个时间段的光线会让人物肤色超通透，不要错过～',
    '黄金时刻拍逆光剪影，让人物的轮廓发光～',
    '日落前的光线变化很快，抓住最佳时机按下快门～',
  ],
  // 撸猫撸狗咖啡馆专属建议
  pet_cafe_specific: [
    '宠物咖啡馆光线偏暗！找窗边位置让光线打在宠物身上～',
    '猫咪注意力短暂！提前对焦好，等它看向镜头时快速按下快门～',
    '用零食吸引宠物注意力，让它看向镜头方向～',
    '宠物咖啡馆背景通常较杂乱，开大光圈虚化背景～',
    '低角度拍猫狗更可爱！蹲下来和宠物视线平齐～',
    '撸猫时表情自然最生动！和猫咪互动时抓拍～',
    '对着窗户拍，光线打在毛上超有质感～',
    '连拍模式超有用！宠物动作很快，多拍几张选最好的～',
  ],
  // 宠物合影专属建议
  pet_photo_specific: [
    '宠物眼睛要有眼神光！让窗户的光打在眼睛上～',
    '低角度拍宠物更可爱！蹲下来和宠物视线平齐～',
    '对焦在宠物眼睛上！眼睛是照片的灵魂～',
    '宠物注意力只有几秒！提前对焦好，等它看向镜头时快速按下快门～',
    '连拍模式超有用！宠物动作很快，连拍几张选最好的～',
    '用零食或玩具吸引宠物注意力，让它看向镜头方向～',
    '背景要干净！虚化背景让宠物更突出～',
    '户外阳光下拍宠物最上镜！毛发光泽超好看～',
  ],
  // 火锅美食专属建议
  hotpot_specific: [
    '火锅蒸汽超有氛围！等蒸汽升腾的瞬间按下快门～',
    '火锅店灯光通常偏暖黄，适当降低色温让食物颜色更真实～',
    '对着蒸汽方向拍摄，蒸汽会让光线更柔和～',
    '火锅食材颜色鲜艳，找个干净的背景让主体更突出～',
    '热气腾腾的火锅最上镜！不要等太久，趁着蒸汽正浓时拍～',
    '火锅店背景通常较暗，开手机屏幕补光在食物上～',
    '用筷子夹起食材的瞬间抓拍，动态感十足～',
    '侧逆光打火锅，汤色红亮超有食欲感～',
  ],
  // 日落晚霞专属建议
  ...
  // 机场/车站专属建议（airport_good praise 池已存在）
  airport_specific: [
    '机场光线通常很均匀！找到大窗边的位置，光打在脸上超自然～',
    '候机大厅背景简洁，側身站让机场线条做背景超有感～',
    '机场落地窗光线超棒！找一处逆光让轮廓发光～',
    '机场的候机座位区光线偏暗，开屏幕补光让脸亮起来～',
    '机场玻璃幕墙反射很强！斜着拍躲开周围的杂乱～',
    '机场安检通道背景通常是蓝色或灰色，正对光拍最干净～',
    '候机楼的大面积窗户是天然柔光箱！侧身靠近窗户～',
    '机场出发大厅光线充足，对焦在眼睛上构图最稳～',
  ],
  // 书店/图书馆专属建议（bookstore_good praise 池已存在）
  bookstore_specific: [
    '书店光线通常偏暖黄，找一处靠窗位置让光打在脸上～',
    '书架做背景超有文艺感！让人物靠在书架前侧身～',
    '书店灯光偏暗，开屏幕补光让人物从背景中跳出来～',
    '书架间的过道光线斑驳，等一阵光打过来再拍～',
    '书店咖啡角光线最柔和！坐在窗边翻书的瞬间超美～',
    '书店的木质书架做背景很温暖！穿浅色衣服更上镜～',
    '图书馆的落地窗光线超均匀！侧身站让光打在侧脸上～',
    '书店阅读区光线偏暖，适当降低色温让肤色更自然～',
  ],
  // 演唱会/演出专属建议（concert_good praise 池已存在）
  dance_performance_specific: [
    '演唱会灯光忽明忽暗！对焦在人脸上等光打过来时按下快门～',
    '舞台灯光颜色丰富！脸部偏色是正常的，对焦清晰最重要～',
    '演唱会拍摄容易糊！双手握稳手机，开连拍多拍几张～',
    '荧光棒和应援色做背景超有氛围感！开闪光灯正面补光～',
    '演出光线复杂，找一处舞台追光打下来的时候拍～',
    '演唱会拍摄噪点多是正常的！尽量找光最强的瞬间拍～',
    '荧光棒和灯牌做前景虚化，背景是舞台超有层次～',
    '演出结束后的灯光秀是最佳拍摄时机！别急着离开～',
  ],
  // 游乐场/机动游戏专属建议（amusement_ride_good praise 池已存在）
  amusement_ride_specific: [
    '游乐场光线忽明忽暗！找一处光线均匀的地方拍～',
    '游乐场的彩色装饰做背景超活泼！让背景丰富起来～',
    '摩天轮里光线柔和！厢内拍摄角度多变，超有感～',
    '过山车俯冲的瞬间抓拍最刺激！连拍模式用起来～',
    '游乐场晚上灯光秀超浪漫！夜场模式拍起来～',
    '旋转木马光线通常偏暗，开屏幕补光让人物亮起来～',
    '碰碰车场地颜色鲜艳！找一处背景干净的角度拍～',
    '游乐场的花车巡游是最佳拍摄时机！光线足背景丰富～',
  ],
  // 逆光剪影
  backlit_silhouette: [
