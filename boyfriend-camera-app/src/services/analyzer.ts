...
const PRAISE_POOL: Record<string, string[]> = {
  ...
  subway_good: [
    ...
    '男朋友找到了地铁最好的光线，这张绝了！',
    '都市感拿捏了！地铁站也能拍出时尚感～',
    '地铁背景超有都市感，男朋友找角度很有一套！',
    '地下空间的纵深感被男朋友利用得刚刚好，这张很有质感！',
  ],
  // 超市/便利店场景夸奖
  // 泳池边夸奖
  pool_side_good: [
  ...
  christmas_good: [
    ...
    '节日限定照片好有过节气氛，构图超有心思～',
    '圣诞氛围感拉满！这张照片好有过节气氛～',
    '节日限定的快乐被男朋友记录下来了，太会了！',
    '圣诞树灯光下这张照片好浪漫，男朋友好浪漫！',
  ],
  // 复古胶片风格夸奖
  vintage_film_good: [
    '复古胶片感绝了！这色调好有故事感～',
  ...
  neon_light_good: [
    ...
    '霓虹赛博风绝了！这张照片好有未来感～',
    '城市霓虹夜景太有感觉了，男朋友摄影技术开挂了！',
    '彩色灯光让这张照片好有层次感，男朋友太会了！',
  ],
  // 机场车站专属夸奖
  airport_good: [
    ...
    '旅途中的照片最有回忆感，这张好珍贵～',
    '出行记录好有意义！这张照片充满了旅途的故事～',
    '机场车站也能拍出时尚感，男朋友找背景很有眼光！',
    '旅途中的每一刻都值得记录，这张太有意义了！',
  ],
  // 剪影专属夸奖（逆光剪影）
  // 倒影专属夸奖（水面/镜子）
  // 黄金时段专属夸奖
...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // 脸稍微侧了（侧脸/半侧脸）
  face_partial: [
    '这个角度脸有点侧，下次让男友稍微正面一点拍～',
    '侧脸也超美！但试试稍微转回来一点，正脸更显五官立体～',
    '半侧脸很有氛围感，稍微转正一点点会更甜哦～',
    '侧脸杀！不过转过来一点点笑一个，大片感立马上线～',
    '侧着也好看！不过正面照更显精致，下次试试正脸～',
  ],
  // 暗光但非夜景（室内/阴天/傍晚暗处）
  low_light: [
    '光线有点暗，打开手机闪光灯试试～',
    '有点暗，让男友找找窗边的光或者开个补光灯～',
    '光线不足时打开闪光灯或手机手电筒补光～',
    '室内有点暗，靠近窗户让自然光打脸上～',
    '阴天光线偏暗，找个亮一点的地方拍更美～',
    '傍晚光线不够，让男友稍微调亮屏幕或开补光～',
  ],
  // 硬光/顶光（正午阳光/顶灯直射）
  harsh_light: [
    '光线太硬了，脸上有奇怪阴影，往阴凉处站一站～',
    '正午阳光太强，顶光在脸上留下难看的影子～',
    '光线太顶了，脸上的阴影好明显，躲一躲光试试～',
  ...
  flower_shop: [
    ...
    '花店里的暖黄灯光打在脸上超温柔，让男友稍微靠近一点拍～',
    '花束捧在胸前，微微低头看向花朵，这个角度超美～',
  ],
  ...
  spring_outdoor: [
    ...
    '春天树叶新绿，背景干净通透，人景比例三七开最舒服～',
    '户外踏青找一片花丛或草地，让花瓣散落在头发上，超浪漫～',
  ],
  ...
  autumn_leaves: [
    ...
    '站在红叶树下抬头看，光影斑驳超有氛围感～',
    '秋天红叶背景偏暗红，适当增加一点曝光补偿让肤色更亮～',
    '捡起一片落叶当道具，和叶子互动表情更生动～',
  ],

  // 新增：衣着与背景颜色和谐建议（正反馈）
  outfit_color_match_extra: [
    '衣服和背景颜色好搭！这配色感觉好舒服～',
    '穿着和场景很配！整体色调统一看起来超和谐～',
    '衣服颜色和环境呼应，这张好有整体感～',
    '颜色搭配好协调！整体感很强，看起来好舒服～',
  ],

  // 新增：过度摆拍建议（表情/姿势太刻意，不够自然）
  over_posed: [
  ...
  // 新增：多人合照自拍专属建议
  group_selfie_tips: [
    '自拍杆举起让所有人都入镜！稍微仰角俯拍，大家脸都不会被挡～',
    '多人自拍站两边让中间的人举手机，这样角度最公平～',
    '自拍时让脸最靠近镜头，中间的人脸会显小，两边的显大～',
    '用倒计时或手势快门，避免有人手短按不到快门～',
    '多人自拍背景要干净！找面纯色墙或简洁背景，这样每个人都能被看清～',
  ],

  // 新增：闪光灯过强建议
  flash_too_harsh: [
    '闪光灯打得太强了，脸上高光有点过曝！稍微拉远一点或调低亮度试试～',
    '闪光灯直接打脸会有点硬，可以离远一点让光更柔和～',
    '闪光灯直射会让皮肤显得太亮，离远一点或侧着打光会更自然～',
    '开了闪光灯脸太白了！稍微后退一点让光更分散，肤色更自然～',
  ],

  // 新增：构图稳定但无亮点（及格分专属，鼓励突破）
  safe_but_bland: [
    '这张及格了！但还能更好！换个角度或调整光线试试～',
    '构图还行！下次试试换个姿势或角度，会有惊喜哦～',
    '这张稳定发挥，下次试试让光线更有层次，构图会更出色～',
    '及格没问题！下次试试换个背景或表情，进步会更快～',
  ],
  // 新增：宠物入镜场景建议
  pet_in_photo_tips: [
    '宠物和女友同框超有爱！让毛孩子先安静下来再拍～',
    '拍宠物要快！它们不会一直保持一个姿势～',
    '让女友蹲下来和宠物平视，画面更有互动感～',
    '宠物活泼好动，连拍模式最适合捕捉它们～',
  ],
