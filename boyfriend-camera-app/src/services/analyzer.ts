...
const SUGGESTION_POOL: Record<string, string[]> = {
  ...
  // ========== Round 41 新增：眼镜反光建议 ==========
  glasses_glare: [
    '眼镜镜片反光太亮了！稍微侧一下脸躲开光源～',
    '眼镜反光看不清眼睛了，让男朋友换个角度试试～',
    '镜片反光太明显了，抬头或低头一点点就能躲开～',
    '眼镜一族试试把头稍微抬高一点，反光会少很多～',
    '镜片反光挡住了眼神光，侧身或抬头躲开试试～',
  ],
  // ========== Round 41 新增：多人合照站位建议 ==========
  group_standing_tips: [
    '多人合照时，让矮的人站前面，高的人站后面～',
    '后排的人稍微岔开腿站，这样每个人都能露出来～',
    '合照别挤成一团，稍微错开站更自然更好看～',
    '让表情最自然的人站中间，能带动整体氛围～',
    '多人拍摄前先对好焦，不然后排会糊掉～',
  ],
  // ========== Round 41 新增：服装与背景对比建议 ==========
  outfit_background_contrast: [
    '衣服颜色和背景太接近了，换个背景或换件衣服会更突出～',
    '浅色衣服配深色背景，或深色衣服配浅色背景，对比感更强烈～',
    '衣服颜色太花会让背景显得杂乱，纯色衣服更上镜～',
    '穿和背景反差大的颜色，主体会更突出更吸睛～',
    '白色衣服在浅色背景里会融进去，换个深色背景试试～',
  ],
  // ========== Round 41 新增：眼神交流建议 ==========
  eye_contact_tips: [
    '眼神不知道看哪里？让她看镜头或看旁边的参照物～',
    '眼神太飘了！定睛看一个点再按快门～',
    '眼睛看远方更有故事感，假装在看远处的风景～',
    '眼睛有光才好看，让光源在眼睛里形成眼神光～',
    '别死盯着镜头看，那样表情会僵硬，假装在看旁边～',
  ],
  // ========== Round 41 新增：室内色温建议 ==========
  indoor_color_temp: [
    '室内灯光偏黄，拍出来肤色会偏暖，适当补光会更自然～',
    '白炽灯下肤色偏黄，可以靠近窗户用自然光～',
    '暖色调灯光下肤色会偏暖，这是氛围感的一部分不用太在意～',
    '荧光灯会有点绿调，靠近窗户或开闪光灯能改善～',
    '商场灯光偏冷白，可以让脸稍微偏向窗户补补暖～',
  ],
  ...
  clothing_hint: [
    '衣服颜色和背景太接近了，换个角度或背景试试～',
    '深色衣服配浅色背景，或者浅色衣服配深色背景，对比更好看～',
    '纯色衣服比花衣服更上镜，拍照时选纯色更安全～',
    '衣服领口露出一边锁骨，优雅又显瘦～',
    '领口歪了！稍微整理一下再拍，会更精神～',
    '解开一颗扣子比全扣更自然，随性一点更好看～',
  ],
  // Round 42: Hair tips
  hair_style_hint: [
    '头发挡住脸了，轻轻拨开，光会更通透～',
