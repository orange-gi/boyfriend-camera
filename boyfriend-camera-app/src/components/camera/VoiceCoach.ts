...
const SCENE_TIPS: Record<string, string[]> = {
  ...
  golden_hour: [
    '现在是黄金时段！光最温柔，赶紧拍几张～',
    '夕阳余晖打在脸上好温暖，侧脸绝了！',
    'Golden Hour 光线超美，男朋友快按快门！',
  ],
  overcast: [
    '阴天光线超柔和！不用怕过曝，随便拍都好看～',
    '云层就是天然柔光箱，光线均匀拍人像绝了！',
  ],
  // 新增场景：健身房
  gym: [
    '健身房镜子前光线均匀！侧身站着，笑得灿烂超有活力～',
    '运动后出汗皮肤光泽感超好！趁着汗还没干赶紧拍～',
    '健身房器械区背景好有运动感！侧身站着举起哑铃～',
    '动起来抓拍！跑跳的瞬间最有活力～',
  ],
  // 新增场景：书店/图书馆
  bookstore: [
    '书店里光线超有质感！男朋友这构图很有文艺气息～',
    '书架前随意翻书，这个瞬间最自然～',
    '书香气质拉满，男朋友你懂文艺风！',
  ],
  // 新增场景：泳池边
  ...
  // 新增场景：超市
  supermarket: [
    '超市货架前光线均匀！拿个零食当道具，俏皮又自然～',
    '货架前背景有点乱，打开人像模式虚化背景～',
    '拿个零食饮料对着镜头笑，这个角度绝了～',
  ],
  // 新增场景：画廊艺术展
  gallery: [
    '画廊看展超有文化感！站在艺术品旁侧头微笑，文艺感拉满～',
    '艺术展灯光打在侧脸上，这光影绝了！',
    '画廊极简白墙超有高级感，男朋友这构图有品味！',
  ],
  // 新增场景：超市冰柜前
  ice_cream: [
    '冰柜前光线冷白！侧身躲开冷光正面拍摄会更通透～',
    '拿瓶饮料俏皮地笑一个，这表情绝了～',
    '便利店冰柜前光线偏白，侧身让光打在侧脸上～',
  ],
  food_scene: [
    '美食和人都要入镜！稍微后退一点，构图更好～',
    '餐厅靠窗位置光线最柔和，就是现在拍～',
    '美食照让人也入镜，画面更有故事感！',
  ],
}
